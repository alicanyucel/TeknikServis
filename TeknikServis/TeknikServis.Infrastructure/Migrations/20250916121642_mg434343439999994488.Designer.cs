...
namespace TeknikServis.Infrastructure.Migrations
{
    ...
    [Migration("20250916121642_mg434343439999994488")]
    partial class mg434343439999994488
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TeknikServis.Domain.Entities.ServiceLineAction", b =>
                {
                    ...
                    b.Property<Guid?>("ServiceActionId1")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TeknikServis.Domain.Entities.ServiceLineAction", b =>
                {
                    ...
                    b.HasOne("TeknikServis.Domain.Entities.ServiceAction", null)
                        .WithMany("ServiceLineActions")
                        .HasForeignKey("ServiceActionId1");
